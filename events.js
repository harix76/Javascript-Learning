...
document.getElementById('images').addEventListener('click', function (params) {
    console.log(params.target.parentNode);
    if (params.target.tagName === 'IMG') {
         let removeit = params.target.parentNode
    removeit.remove()
